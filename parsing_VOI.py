...
class ParseVOI(object):
    '''
    Convert multiple VOI files in a directory to slice-specific XML files with a bounding box for
    each slice.
    '''
...
if __name__=='__main__':
    output=ParseVOI()
    print(output.list_of_dicts(filepath=r'S:\MIP\MIP\Robert Huang'))
